...
import com.springSecurity.authify.io.AuthRequest;
import com.springSecurity.authify.io.AuthResponse;
import com.springSecurity.authify.io.ResetPasswordRequest;
import com.springSecurity.authify.service.AppUserdetailsService;
import com.springSecurity.authify.service.ProfileService;
import com.springSecurity.authify.util.JwtUtil;
...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthRequest request){
        try
        {
            ...
            ResponseCookie cookie = ResponseCookie.from("jwt", jwtToken) // Use .from for better compatibility
                    .httpOnly(true)
                    .path("/")
